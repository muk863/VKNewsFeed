...
class NewsfeedPresenter: NewsfeedPresentationLogic {
    ...
    private func cellViewModel(from feedItem: FeedItem, profiles: [Profile], groups: [Group]) -> FeedViewModel.Cell {
        ...
        let sizes = cellLayoutCalculator.sizes(postText: feedItem.text, photoAtachment: photoAttachment)
    ...
    private func profile(for sourseId: Int, profiles: [Profile], groups: [Group]) -> ProfileRepresenatable {
        ...
        let profileRepresenatable = profilesOrGroups.first { (myprofileRepresenatable) in
