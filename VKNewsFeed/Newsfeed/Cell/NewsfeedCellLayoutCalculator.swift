...
//  VKNewsFeed
//
//  Created by username on 21.10.2021.
//
...
protocol FeedCellLayoutCalculatorProtocol {
    ...
    func sizes(postText: String?, photoAtachment: FeedCellPhotoAttachmentViewModel?) -> FeedCellSizes
}
...
final class FeedCellLayoutCalculator: FeedCellLayoutCalculatorProtocol {
    ...
    func sizes(postText: String?, photoAtachment: FeedCellPhotoAttachmentViewModel?) -> FeedCellSizes {
        ...
        if let attachment = photoAtachment {
        ...
        let bottomViewFrame = CGRect(origin: CGPoint.init(x: 0, y: bottomViewTop),
